...
class UsuarioServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.BuscarUsuario = channel.unary_unary(
                ...
                request_serializer=servicio__pb2.UsuarioRequest.SerializeToString,
                response_deserializer=servicio__pb2.UsuarioResponse.FromString,
...
def add_UsuarioServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'BuscarUsuario': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=servicio__pb2.UsuarioRequest.FromString,
                    response_serializer=servicio__pb2.UsuarioResponse.SerializeToString,
            ),
    }
...
class UsuarioService:
    ...
    def BuscarUsuario(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UsuarioService/BuscarUsuario',
            servicio__pb2.UsuarioRequest.SerializeToString,
            servicio__pb2.UsuarioResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

...
class ProductoServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.ObtenerProducto = channel.unary_unary(
                ...
                request_serializer=service__pb2.ProductoRequest.SerializeToString,
                response_deserializer=service__pb2.ProductoResponse.FromString,
                _registered_method=True)
        self.CrearProducto = channel.unary_unary(
                '/producto.ProductoService/CrearProducto',
                request_serializer=service__pb2.CrearProductoRequest.SerializeToString,
                response_deserializer=service__pb2.ProductoResponse.FromString,
                _registered_method=True)
...
def add_ProductoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ObtenerProducto': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.ProductoRequest.FromString,
                    response_serializer=service__pb2.ProductoResponse.SerializeToString,
            ),
            'CrearProducto': grpc.unary_unary_rpc_method_handler(
                    servicer.CrearProducto,
                    request_deserializer=service__pb2.CrearProductoRequest.FromString,
                    response_serializer=service__pb2.ProductoResponse.SerializeToString,
            ),
    }
...
class ProductoService:
    ...
    def ObtenerProducto(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/producto.ProductoService/ObtenerProducto',
            service__pb2.ProductoRequest.SerializeToString,
            service__pb2.ProductoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CrearProducto(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/producto.ProductoService/CrearProducto',
            service__pb2.CrearProductoRequest.SerializeToString,
            service__pb2.ProductoResponse.FromString,
            options,
            channel_credentials,
            insecure,

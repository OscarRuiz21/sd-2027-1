...
Aquí se puede ver el error al intentar utilizar el mismo puerto. Básicamente sucede porque el puerto ya está utilizado
...
Ejecutando el comando docker ps se puede ver que se tienen los dockers levantados
docker ps
...
Comparten la versión del archivo con el que se creó el build. Este archivo vive dentro de la imagen, al momento de modificar el archivo fuera
del contenedor no se verán los cambios en ninguno de los dos. Pero si en mi docker 1 modifico su archivo interno sí tendrá cambios, mientras que,
para un docker 2 creado con la misma imagen no se verán los cambios porque su archivo index es propio y está aislado del sistema y del otro docker.
Siendo así que se puede visualizar el propósito de docker que es el aislamiento de un entorno replicable.
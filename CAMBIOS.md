...
- **S05 (sábado 19 de septiembre)**: deck `material/S05/` (HTML y PDF) y laboratorio `labs/Lab-S05-Mexi-Banco-Compose.md` con su rúbrica. Tema: de Compose a orquestación, con una introducción a consenso (latido, elección, quórum). Kubernetes se ve como demo del profesor; el lab es Docker Compose sobre Mexi Banco.
